  ...
  return (
    <>
          ...
          {!colapsado && (
            <div className="brand">
              ...
              <span className="sidebar-company-name">
                Viviendas y Desarrollo de Teziutlan de S.A de C.V.
              </span>
        ...
        {!colapsado && (
          <>
            ...
            <nav>
              ...
              <NavLink
                to="/trabajadores?pendiente=evaluacion"
                className={({ isActive }) =>
                  'nav nav-secondary ' +
                  (isActive ? 'active' : '')
                }
            ...
            <nav>
              ...
              <a
                href="https://control-de-calidad-calidad-next.vercel.app/control"
                target="_blank"
      ...
      {colapsado && !isMobile && (
        <button
          type="button"
          className="sidebar-toggle-flotante"
          onClick={toggleSidebar}
